        ...
        <Flex direction="column" align="center" mt={8}>
          ...
          {isLoggedIn ? (
              <Flex direction="column" align="center" p={4} bg="purple.50" borderRadius="md" mb={4}>
                <Text fontSize="xl" fontWeight="bold" mb={2}>{t('hello', { username })}</Text>
                <Text mb={4}>{t('howAreYou')}</Text>
                <Flex>
                  <Button as={ReactRouterLink} to="/tasks" colorScheme="purple" mr={4}>{t('myTasks')}</Button>
                  <Button as={ReactRouterLink} to="/my-groups" colorScheme="purple">{t('myGroups')}</Button>
                </Flex>
              </Flex>
          ) : (
              <Flex direction="column" align="center" p={4} bg="purple.50" borderRadius="md" mb={4}>
                <Text mb={4}>{t('loginPrompt')}</Text>
                <Button as={ReactRouterLink} to="/signin" colorScheme="purple">{t('login')}</Button>
              </Flex>
          )}
        </Flex>
      </Box>

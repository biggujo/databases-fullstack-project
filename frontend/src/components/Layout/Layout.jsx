...
export default function Layout() {
  return (
    ...
    >
      ...
      <footer style={{ marginTop: '30px', paddingLeft: '0', paddingBottom: '30px', backgroundColor: '#f5f0ff', border: '1px solid #e2d9ff', borderRadius: '5px' }}>
  	<Divider />
  	<Flex
    	justify="flex-start"
    	align="flex-start"
    	flexDirection="column"
    	style={{ paddingLeft: '45px', paddingTop: '10px' }} // змінено з paddingLeft: '0'
  	>
    	<Text>

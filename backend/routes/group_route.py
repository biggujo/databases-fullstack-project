...
blueprint.route('/<int:id>/users/<int:userid>', methods=['DELETE'])(group_controller.remove_user)
...
blueprint.route('/<int:id>/tasks/<int:task_id>', methods=['PUT'], endpoint='group_tasks_update')(group_controller.tasks_update)
blueprint.route('/<int:id>/tasks/<int:task_id>', methods=['DELETE'], endpoint='group_tasks_delete')(group_controller.tasks_delete)

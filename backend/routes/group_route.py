...
blueprint.route('/<int:id>/tasks/<int:task_id>/subtasks/<int:subtask_id>', methods=['PUT'])(
    group_controller.tasks_update)
blueprint.route('/<int:id>/tasks/<int:task_id>/subtasks/<int:subtask_id>', methods=['DELETE'])(
    group_controller.tasks_delete)

...
blueprint.route('/<int:id>/tasks/<int:task_id>/subtasks', methods=['GET'])(group_controller.subtasks_index)
blueprint.route('/<int:id>/tasks/<int:task_id>/subtasks', methods=['POST'])(group_controller.subtasks_create)
blueprint.route('/<int:id>/tasks/<int:task_id>/subtasks/<int:subtask_id>', methods=['PUT'])(group_controller.subtasks_update)
blueprint.route('/<int:id>/tasks/<int:task_id>/subtasks/<int:subtask_id>', methods=['DELETE'])(group_controller.subtasks_delete)

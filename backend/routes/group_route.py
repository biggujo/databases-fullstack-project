...
blueprint.route('/<int:n>', methods=['GET'])(group_query.show_with_more_than_n_members)
blueprint.route('/joined', methods=['GET'])(group_query.show_with_more_than_n_members)
